...
| `docs/k3/rst/s1-cuda-mla.md` | CUDA gated-NoPE MLA vs CPU; BoundLayer FullAttention **opt-in** `K3_CUDA_MLA=1` (default CPU so aviation greedy cannot regress). C1 with CUDA MLA unproven until spark2 rebuild + spark1 aviation |
