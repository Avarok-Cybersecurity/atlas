...
impl TransformerModel {
    ...
    pub(super) fn decode_forward_body(
        ...
        for (i, layer) in self.layers.iter().enumerate() {
            ...
            // Activation steering. One token on this path. Graph-capture
            ...
            self.cvec_after_layer(ctx, "decode", seq.cvec_id, i, 1, stream)?;
        ...
        // AVAROK_LOGIT_PROBE=1: the DECODE side of the hidden-state A/B against
        ...
        // AVAROK_LOGIT_PROBE=1: the DECODE side of the row-by-row A/B against
