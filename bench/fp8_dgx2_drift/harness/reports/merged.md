# Harness aggregate — tier `merged` (N=10)

Generated from `bench/fp8_dgx2_drift/harness/runs/run_merged_*.json`.
Runs: [1, 10, 2, 3, 4, 5, 6, 7, 8, 9]

| metric | kind | n | mean ± std | p50 | p90 | 95% CI | non-zero runs |
|---|---|---|---|---|---|---|---|
| files_written | count | 10 | 941.200 ± 62.075 | 929.000 | 1091.000 | [908.200, 983.900] | 10/10 |
...
| tool_calls_total | count | 10 | 13.600 ± 4.984 | 16.000 | 24.000 | [10.700, 16.800] | 10/10 |
...
| wall_time_s | count | 10 | 190.648 ± 110.301 | 162.665 | 360.046 | [127.659, 261.797] | 10/10 |
