...
//! `register_exl3_ngram_sidecar` — the EXL3 export's standalone PLE n-gram
//! file, registered into the store under the names the PLE loader expects.
//! Child of `exl3_materialize.rs` (split for the 500-LoC cap); see the fn doc.
