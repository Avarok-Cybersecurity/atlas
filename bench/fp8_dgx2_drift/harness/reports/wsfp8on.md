# Harness aggregate — tier `wsfp8on` (N=10)

Generated from `bench/fp8_dgx2_drift/harness/runs/run_wsfp8on_*.json`.
Runs: [1, 10, 2, 3, 4, 5, 6, 7, 8, 9]

| metric | kind | n | mean ± std | p50 | p90 | 95% CI | non-zero runs |
|---|---|---|---|---|---|---|---|
| files_written | count | 10 | 1012.700 ± 236.201 | 909.000 | 1662.000 | [902.100, 1168.600] | 10/10 |
...
| tool_calls_total | count | 10 | 12.100 ± 3.048 | 12.000 | 17.000 | [10.300, 14.000] | 10/10 |
...
| wall_time_s | count | 10 | 247.139 ± 118.309 | 360.044 | 360.047 | [171.508, 320.163] | 10/10 |
