# Harness aggregate — tier `nothink2` (N=10)

Generated from `bench/fp8_dgx2_drift/harness/runs/run_nothink2_*.json`.
Runs: [1, 10, 2, 3, 4, 5, 6, 7, 8, 9]

| metric | kind | n | mean ± std | p50 | p90 | 95% CI | non-zero runs |
|---|---|---|---|---|---|---|---|
| files_written | count | 10 | 866.000 ± 323.046 | 897.000 | 1390.000 | [638.000, 1044.500] | 10/10 |
...
| tool_calls_total | count | 10 | 14.600 ± 5.219 | 13.000 | 24.000 | [11.600, 18.000] | 10/10 |
| write_calls | count | 10 | 2.300 ± 0.781 | 2.000 | 4.000 | [1.900, 2.800] | 10/10 |
| drift_empty_path | count | 10 | 0.300 ± 0.900 | 0.000 | 3.000 | [0.000, 0.900] | 1/10 |
...
| wall_time_s | count | 10 | 240.856 ± 106.489 | 239.783 | 360.083 | [174.963, 309.645] | 10/10 |
