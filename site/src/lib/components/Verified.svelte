  ...
  <div class="container">
    ...
    <div class="verified-grid">
      <div>
        ...
        <p class="mlperf-note" style="font-size:0.84rem">Every model card comes from a recipe in <a class="link" href={recipesUrl} target="_blank" rel="noopener">avarok-recipes</a>.</p>
      </div>
