# Harness aggregate — tier `prefillpipe` (N=10)

Generated from `bench/fp8_dgx2_drift/harness/runs/run_prefillpipe_*.json`.
Runs: [1, 10, 2, 3, 4, 5, 6, 7, 8, 9]

| metric | kind | n | mean ± std | p50 | p90 | 95% CI | non-zero runs |
|---|---|---|---|---|---|---|---|
| files_written | count | 10 | 939.700 ± 71.430 | 907.000 | 1120.000 | [902.500, 989.300] | 10/10 |
...
| tool_calls_total | count | 10 | 10.100 ± 3.390 | 9.000 | 17.000 | [8.200, 12.400] | 10/10 |
| write_calls | count | 10 | 2.000 ± 0.000 | 2.000 | 2.000 | [2.000, 2.000] | 10/10 |
...
| wall_time_s | count | 10 | 135.672 ± 76.111 | 109.546 | 360.052 | [104.182, 188.489] | 10/10 |
