...
#   atlasD_kmarm — the Phase B binary (SSOT ladder w/ 12+16, can_mix fusion
...
#   atlasD_kmarm_graphs   — same binary + ATLAS_DECODE_GRAPHS_MULTISEQ=1 (strict
#                     =="1"): the n>=2 CUDA-graph lever on top.
#                     vs atlasD_kmarm: the pure graphs delta.
#
...
run_leg atlasD_kmarm ""
run_leg atlasD_kmarm_graphs "-e ATLAS_DECODE_GRAPHS_MULTISEQ=1"
note "PHASED_DONE"
echo "PHASED_DONE"
