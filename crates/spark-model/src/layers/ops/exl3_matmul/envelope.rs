    ...
    fn dense_kernel_names_follow_the_dispatch_rule() {
        ...
        assert_eq!(
            ...
            vec![
                ...
                "exl3_gemm_k6_cb2_sh4_f32_abf16_obf16",
                "exl3_gemm_k6_cb2_sh2_f16",
                "exl3_gemm_k6_cb2_sh2_f32",
                "exl3_gemm_k6_cb2_sh2_f32_abf16",
                "exl3_gemm_k6_cb2_sh2_f32_abf16_obf16",
            ]
        );
        // GDN qkv at K=3: shape 3 + shape 2 (four names each, incl. the
        // BF16-ingress and BF16-egress f32 twins) + the eight gemv instances.
        let names = exl3_dense_kernel_names(2560, 10240, 3, 2).unwrap();
        assert_eq!(names.len(), 8 + 8);
        assert_eq!(names[0], "exl3_gemm_k3_cb2_sh3_f16");
        assert_eq!(names[2], "exl3_gemm_k3_cb2_sh3_f32_abf16");
        assert_eq!(names[3], "exl3_gemm_k3_cb2_sh3_f32_abf16_obf16");
        assert_eq!(names[4], "exl3_gemm_k3_cb2_sh2_f16");
        assert!(
            names[8..]
                .iter()
                .all(|n| n.starts_with("exl3_gemv_k3_cb2_m"))
        );
        // attention k/v at K=6: heuristic itself lands on shape 2 -> four
        ...
        assert_eq!(
            ...
            vec![
                ...
                "exl3_gemm_k6_cb1_sh2_f32_abf16_obf16"
            ]
        );
        ...
        assert_eq!(
            ...
            vec![
                ...
                "exl3_gemm_k8_cb2_sh2_f32_abf16_obf16"
            ]
        );
