...
# The assertions below test this explicit logging policy, not the caller's.
...
# shellcheck source=scripts/fixtures/start_node_ep/cases_ownership.sh
source "$(dirname "$SCRIPT")/fixtures/start_node_ep/cases_ownership.sh"
