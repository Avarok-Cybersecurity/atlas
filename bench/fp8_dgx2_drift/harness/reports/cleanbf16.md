# Harness aggregate — tier `cleanbf16` (N=10)

Generated from `bench/fp8_dgx2_drift/harness/runs/run_cleanbf16_*.json`.
Runs: [1, 10, 2, 3, 4, 5, 6, 7, 8, 9]

| metric | kind | n | mean ± std | p50 | p90 | 95% CI | non-zero runs |
|---|---|---|---|---|---|---|---|
| files_written | count | 10 | 853.100 ± 154.257 | 898.000 | 1036.000 | [746.100, 939.600] | 10/10 |
...
| tool_calls_total | count | 10 | 15.300 ± 3.716 | 15.000 | 24.000 | [13.200, 17.800] | 10/10 |
| write_calls | count | 10 | 2.200 ± 0.980 | 2.000 | 5.000 | [1.700, 2.900] | 10/10 |
...
| atlas_tool_call_lines | count | 10 | 14.300 ± 3.579 | 14.000 | 22.000 | [12.200, 16.600] | 10/10 |
| wall_time_s | count | 10 | 277.812 ± 79.483 | 310.761 | 360.086 | [228.346, 325.249] | 10/10 |
