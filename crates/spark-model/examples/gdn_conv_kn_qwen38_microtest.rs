...
//! [qwen3.8-27b/DFlash2 geometry clone: NV=48, K=8 — the original tests
//! K=17/NV=32 (qwen3.6 DFlash1) only; every stale-geometry test in this
//! audit has hidden a real gap so far]
...
const K: usize = 8; // DFlash2 γ=8 verify width (qwen3.8-27b)
