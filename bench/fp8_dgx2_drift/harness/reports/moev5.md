# Harness aggregate — tier `moev5` (N=10)

Generated from `bench/fp8_dgx2_drift/harness/runs/run_moev5_*.json`.
Runs: [1, 10, 2, 3, 4, 5, 6, 7, 8, 9]

| metric | kind | n | mean ± std | p50 | p90 | 95% CI | non-zero runs |
|---|---|---|---|---|---|---|---|
| files_written | count | 10 | 968.500 ± 136.041 | 913.000 | 1342.000 | [903.600, 1061.300] | 10/10 |
...
| tool_calls_total | count | 10 | 12.300 ± 3.689 | 12.000 | 19.000 | [10.200, 14.700] | 10/10 |
| write_calls | count | 10 | 2.100 ± 0.300 | 2.000 | 3.000 | [2.000, 2.300] | 10/10 |
...
| wall_time_s | count | 10 | 186.221 ± 96.811 | 172.105 | 360.046 | [130.442, 249.681] | 10/10 |
