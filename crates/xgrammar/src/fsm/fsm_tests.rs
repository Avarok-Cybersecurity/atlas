...
// code file stays under the 250-line cap (included via `#[path]`).
    ...
    fn add_states_and_edges() {
        ...
        assert_eq!(f.next_state(a, b'y' as i32, edge_type::CHAR_RANGE), b as i32);
        assert_eq!(f.next_state(a, b'w' as i32, edge_type::CHAR_RANGE), NO_NEXT_STATE);
    }
    ...
    fn advance_uses_epsilon_closure() {
        ...
        f.advance(&from, b'a' as i32, &mut result, edge_type::CHAR_RANGE, false);
