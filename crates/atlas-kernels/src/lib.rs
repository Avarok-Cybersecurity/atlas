...
pub mod serve_preset;
pub use serve_preset::ServePreset;
...
pub struct TargetPtxSet {
    ...
    /// resolves through [`preset_named`]. Empty for targets that declare none.
    pub serve_presets: &'static [ServePreset],
}

mod query;
pub use query::{available_targets, preset_named, ptx_for_model};
