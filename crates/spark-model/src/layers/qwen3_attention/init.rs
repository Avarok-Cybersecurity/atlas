...
impl Qwen3AttentionLayer {
    ...
    fn new_with_gating(
        ...
        Ok(Self {
            ...
            layer_scalar: None,
            ple: None,
            ple_slice: std::sync::atomic::AtomicU64::new(0),
            ple_mul_k: super::super::try_kernel(gpu, "gemma4_ple", "gemma4_ple_mul"),
            gelu_tanh_k: super::super::try_kernel(gpu, "gelu", "gelu_tanh"),
            kv_shared: false,
            moe_ffn: None,
            pre_moe_norm: None,
