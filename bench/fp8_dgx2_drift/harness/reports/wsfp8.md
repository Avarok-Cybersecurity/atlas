# Harness aggregate — tier `wsfp8` (N=10)

Generated from `bench/fp8_dgx2_drift/harness/runs/run_wsfp8_*.json`.
Runs: [1, 10, 2, 3, 4, 5, 6, 7, 8, 9]

| metric | kind | n | mean ± std | p50 | p90 | 95% CI | non-zero runs |
|---|---|---|---|---|---|---|---|
| files_written | count | 10 | 821.200 ± 276.246 | 892.000 | 1039.000 | [628.500, 936.400] | 10/10 |
...
| tool_calls_total | count | 10 | 13.000 ± 2.366 | 14.000 | 16.000 | [11.400, 14.400] | 10/10 |
...
| wall_time_s | count | 10 | 147.651 ± 47.059 | 132.291 | 245.530 | [121.841, 179.842] | 10/10 |
