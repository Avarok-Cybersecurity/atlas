...
TARGET=$(ls -d /mnt/gx10-hf-hub/models--Blackfrost-Research--M.O.G.-SEC-27B-1M-CTX-NVFP4/snapshots/*/ | head -1)
...
exec ./target/release/spark serve \
  ...
  --model-name Blackfrost-Research/M.O.G.-SEC-27B-1M-CTX-NVFP4 \
  ...
  --lm-head-dtype fp8 --default-top-n-sigma 0 \
  "${TUI_ARGS[@]}"
