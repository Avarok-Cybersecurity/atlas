...
use crate::layers::ops::{
    self, KQUANT_MODULE, Q2K_MMQ_SMEM, Q3K_MMQ_SMEM, Q8_1_BLOCK_BYTES, ResidentMat,
    kquant_mmq_act_bytes, kquant_mmq_gemm, kquant_mmvq_experts_w, kquant_mmvq_w, kquant_q8_1_rows,
...
impl MoeV41 {
    ...
    fn routed_m1(&self, gpu: &dyn GpuBackend, x: DevicePtr, ne: usize, stream: u64) -> Result<()> {
        let c = &self.cfg;
