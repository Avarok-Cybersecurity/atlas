...
/// One byte range of one missed expert's fetch, as the reader threads take
/// it: `(slot, key, slot pointer, byte offset, byte length)`.
type MissPart = (u32, (u32, u32), SlotPtr, usize, usize);
