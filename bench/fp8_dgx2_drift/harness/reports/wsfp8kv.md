# Harness aggregate — tier `wsfp8kv` (N=10)

Generated from `bench/fp8_dgx2_drift/harness/runs/run_wsfp8kv_*.json`.
Runs: [1, 10, 2, 3, 4, 5, 6, 7, 8, 9]

| metric | kind | n | mean ± std | p50 | p90 | 95% CI | non-zero runs |
|---|---|---|---|---|---|---|---|
| files_written | count | 10 | 999.500 ± 413.008 | 959.000 | 1560.000 | [729.700, 1235.800] | 10/10 |
...
| tool_calls_total | count | 10 | 15.300 ± 6.116 | 15.000 | 27.000 | [11.700, 19.200] | 10/10 |
...
| wall_time_s | count | 10 | 184.737 ± 78.010 | 192.157 | 360.046 | [138.961, 235.947] | 10/10 |
