...
//! `MoeLayer::new_with_hash`, split out of `init.rs` to keep it under the
//! 500-line cap.
...
impl MoeLayer {
    ...
    pub fn new_with_hash(
        ...
        Ok(Self {
            ...
            w4a16_gemv_sw: try_kernel(gpu, "w4a16_gemv", "w4a16_gemv_sw"),
            ...
            moe_topk_f32: try_kernel(gpu, "moe_topk", "moe_topk_softmax_f32"),
            ...
            moe_expert_gate_up_shared_batchn: try_kernel(
                gpu,
                "moe_fused_batchn",
                "moe_expert_gate_up_shared_batchn",
            ),
            moe_expert_silu_down_shared_batchn: try_kernel(
                gpu,
                "moe_fused_batchn",
                "moe_expert_silu_down_shared_batchn",
            ),
            moe_weighted_sum_blend_batchn: try_kernel(
                gpu,
                "moe_fused_batchn",
                "moe_weighted_sum_blend_batchn",
            ),
            w4a16_gemv_batch8_k: try_kernel(gpu, "w4a16_gemv", "w4a16_gemv_batch8"),
            w4a16_gemv_batch16_k: try_kernel(gpu, "w4a16_gemv", "w4a16_gemv_batch16"),
            ...
            moe_decode_atomic_c4_silu_down_accum_k: try_kernel(
                gpu,
                "moe_decode_atomic_c4",
                "moe_decode_atomic_c4_silu_down_accum",
            ),
            moe_decode_atomic_c4_finalize_k: try_kernel(
                gpu,
                "moe_decode_atomic_c4",
            ...
            moe_grouped_gemm_e8m0: try_kernel(
                gpu,
                "moe_w4a16",
                "moe_w4a16_grouped_gemm_ptrtable_e8m0",
            ),
            moe_grouped_gemm_t_e8m0: try_kernel(
                gpu,
                "moe_w4a16",
                "moe_w4a16_grouped_gemm_ptrtable_t_e8m0",
            ),
            moe_grouped_gemm_t_k64_e8m0: try_kernel(
                gpu,
                "moe_w4a16",
                "moe_w4a16_grouped_gemm_ptrtable_t_k64_e8m0",
            ),
            moe_fused_gate_up_t_e8m0: try_kernel(
                gpu,
                "moe_w4a16",
                "moe_w4a16_fused_gate_up_t_e8m0",
            ),
            moe_fused_gate_up_t_k64_e8m0: try_kernel(
                gpu,
                "moe_w4a16",
            ...
            moe_fused_gate_up_t_k64_m128: try_kernel(
                gpu,
                "moe_w4a16",
            ...
            moe_fp8_grouped_gemm_k: try_kernel(gpu, "moe_fp8_grouped_gemm", "moe_fp8_grouped_gemm"),
            ...
            moe_build_tile_worklist_k: try_kernel(gpu, "moe", "moe_build_tile_worklist"),
            moe_w8a8_grouped_gemm_k: try_kernel(
                gpu,
            ...
            moe_w8a8_grouped_gemm_pm4_k: try_kernel(
                gpu,
                "moe_w8a8_grouped_gemm",
                "moe_w8a8_grouped_gemm_pm4",
            ),
            per_token_group_quant_fp8_k: try_kernel(
                gpu,
            ...
            silu_mul_quant_fp8_k: try_kernel(gpu, "moe_silu_mul", "silu_mul_quant_fp8"),
            fp8_gemm_t_blockscaled_k: try_kernel(
                gpu,
                "fp8_gemm_t_blockscaled",
                "fp8_gemm_t_blockscaled",
            ),
            moe_bf16_grouped_gemm_k: try_kernel(
                gpu,
                "moe_bf16_grouped_gemm",
                "moe_bf16_grouped_gemm",
            ),
            moe_expert_gate_up_shared_bf16_k: try_kernel(
                gpu,
                "moe_shared_expert_fused_bf16",
                "moe_expert_gate_up_shared_bf16",
            ),
            moe_expert_silu_down_shared_bf16_k: try_kernel(
                gpu,
                "moe_shared_expert_fused_bf16",
                "moe_expert_silu_down_shared_bf16",
            ),
            moe_expert_gate_up_shared_bf16_batch2_k: try_kernel(
                gpu,
                "moe_shared_expert_fused_bf16_batch2",
                "moe_expert_gate_up_shared_bf16_batch2",
            ),
            moe_expert_silu_down_shared_bf16_batch2_k: try_kernel(
                gpu,
                "moe_shared_expert_fused_bf16_batch2",
                "moe_expert_silu_down_shared_bf16_batch2",
            ),
            w8a16_gemm_k: try_kernel(gpu, "w8a16_gemm", "w8a16_gemm"),
            w8a16_gemm_pipelined_k: try_kernel(gpu, "w8a16_gemm_pipelined", "w8a16_gemm_pipelined"),
            moe_gate_topk_fused_k: try_kernel(gpu, "moe_gate_topk", "moe_gate_topk_fused"),
            ...
            moe_expert_gate_up_shared_t_e8m0_k: try_kernel(
                gpu,
                "moe_shared_expert_fused_t",
                "moe_expert_gate_up_shared_t_e8m0",
            ),
            moe_expert_silu_down_shared_t_e8m0_k: try_kernel(
                gpu,
                "moe_shared_expert_fused_t",
            ...
            moe_topk_sqrtsoftplus_k: try_kernel(gpu, "moe_topk_sqrt", "moe_topk_sqrtsoftplus"),
            moe_topk_sqrtsoftplus_batched_k: try_kernel(
                gpu,
                "moe_topk_sqrt",
            ...
            moe_topk_softmax_bias_k: try_kernel(
                gpu,
                "moe_topk_softmax_bias",
                "moe_topk_softmax_bias",
            ),
            moe_topk_softmax_bias_batched_k: try_kernel(
                gpu,
                "moe_topk_softmax_bias",
                "moe_topk_softmax_bias_batched",
            ),
            moe_zero_expert_add_k: try_kernel(gpu, "moe_topk_softmax_bias", "moe_zero_expert_add"),
            ...
            moe_hash_route_k: try_kernel(gpu, "moe_hash_route", "moe_hash_route"),
            moe_hash_route_batched_k: try_kernel(gpu, "moe_hash_route", "moe_hash_route_batched"),
            tid2eid_dev,
            ...
            moe_down_t_k64_fp4: try_kernel(gpu, "moe_w4a16", "moe_w4a16_down_t_k64_fp4"),
            moe_permute_tokens_k: try_kernel(gpu, "moe", "moe_permute_tokens"),
            ...
            // build).
            moe_topk_sigmoid_k: try_kernel(gpu, "moe_topk_sig", "moe_topk_sigmoid"),
            moe_topk_sigmoid_batched_k: try_kernel(gpu, "moe_topk_sig", "moe_topk_sigmoid_batched"),
        })
    }
}
