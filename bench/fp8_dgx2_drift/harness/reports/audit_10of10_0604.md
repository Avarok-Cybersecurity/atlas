# Harness aggregate — tier `audit_10of10_0604` (N=10)

Generated from `bench/fp8_dgx2_drift/harness/runs/run_audit_10of10_0604_*.json`.
Runs: [1, 10, 2, 3, 4, 5, 6, 7, 8, 9]

| metric | kind | n | mean ± std | p50 | p90 | 95% CI | non-zero runs |
|---|---|---|---|---|---|---|---|
| files_written | count | 10 | 984.300 ± 207.154 | 903.000 | 1424.000 | [860.600, 1118.600] | 10/10 |
...
| tool_calls_total | count | 10 | 12.700 ± 2.100 | 13.000 | 17.000 | [11.400, 14.100] | 10/10 |
| write_calls | count | 10 | 2.500 ± 0.922 | 2.000 | 5.000 | [2.000, 3.100] | 10/10 |
...
| wall_time_s | count | 10 | 274.004 ± 66.660 | 309.867 | 360.049 | [233.349, 314.714] | 10/10 |
