# Harness aggregate — tier `wsnvfp4` (N=10)

Generated from `bench/fp8_dgx2_drift/harness/runs/run_wsnvfp4_*.json`.
Runs: [1, 10, 2, 3, 4, 5, 6, 7, 8, 9]

| metric | kind | n | mean ± std | p50 | p90 | 95% CI | non-zero runs |
|---|---|---|---|---|---|---|---|
| files_written | count | 10 | 1127.900 ± 495.597 | 935.000 | 2455.000 | [873.600, 1475.300] | 10/10 |
...
| tool_calls_total | count | 10 | 19.100 ± 8.734 | 16.000 | 41.000 | [14.400, 25.200] | 10/10 |
| write_calls | count | 10 | 1.800 ± 0.748 | 2.000 | 3.000 | [1.400, 2.300] | 10/10 |
...
| wall_time_s | count | 10 | 187.230 ± 76.834 | 217.753 | 296.793 | [139.805, 235.134] | 10/10 |
