...
pub fn swap_out_sequence(
    ...
    Ok(SwappedSeq {
        ...
        min_content_tokens: a.min_content_tokens,
        min_thinking_tokens: a.min_thinking_tokens,
...
pub fn resume_swapped_seq(
    ...
    Ok(ActiveSeq {
        ...
        min_content_tokens: s.min_content_tokens,
        min_thinking_tokens: s.min_thinking_tokens,
