# Harness aggregate — tier `eosfix_on` (N=10)

Generated from `bench/fp8_dgx2_drift/harness/runs/run_eosfix_on_*.json`.
Runs: [1, 10, 2, 3, 4, 5, 6, 7, 8, 9]

| metric | kind | n | mean ± std | p50 | p90 | 95% CI | non-zero runs |
|---|---|---|---|---|---|---|---|
| files_written | count | 10 | 928.000 ± 71.600 | 906.000 | 1140.000 | [899.100, 977.800] | 10/10 |
...
| tool_calls_total | count | 10 | 11.300 ± 2.759 | 12.000 | 16.000 | [9.600, 13.000] | 10/10 |
...
| wall_time_s | count | 10 | 205.738 ± 92.968 | 180.164 | 360.044 | [151.181, 266.128] | 10/10 |
