# Harness aggregate — tier `vllm_ref_0604` (N=10)

Generated from `bench/fp8_dgx2_drift/harness/runs/run_vllm_ref_0604_*.json`.
Runs: [1, 10, 2, 3, 4, 5, 6, 7, 8, 9]

| metric | kind | n | mean ± std | p50 | p90 | 95% CI | non-zero runs |
|---|---|---|---|---|---|---|---|
| files_written | count | 10 | 1117.500 ± 252.813 | 1140.000 | 1679.000 | [979.300, 1284.600] | 10/10 |
...
| tool_calls_total | count | 10 | 15.400 ± 5.238 | 14.000 | 26.000 | [12.400, 18.900] | 10/10 |
| write_calls | count | 10 | 2.600 ± 1.744 | 2.000 | 5.000 | [1.600, 3.700] | 9/10 |
...
| wall_time_s | count | 10 | 143.863 ± 81.377 | 131.915 | 360.061 | [101.533, 200.343] | 10/10 |
