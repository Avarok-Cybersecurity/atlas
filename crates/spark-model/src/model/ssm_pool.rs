...
mod slot_guard_tests {
    ...
    fn bare_pool(max_slots: usize) -> Arc<SsmStatePool> {
        Arc::new(SsmStatePool {
            ...
            h_state_bases_dev: DevicePtr::NULL,
            conv_state_bases_dev: DevicePtr::NULL,
            h_checkpoint_bases_dev: DevicePtr::NULL,
            conv_checkpoint_bases_dev: DevicePtr::NULL,
            h_intermediate_bases_dev: DevicePtr::NULL,
            conv_intermediate_bases_dev: DevicePtr::NULL,
            h_bytes: 0,
            conv_bytes: 0,
            max_slots,
            mtp_slots: 0,
