...
#
# Start Sehyo/Qwen3.5-35B-A3B-Turbo4 + LiteLLM proxy
# — thinking mode DISABLED globally
# — MTP speculative K=2 (num-drafts 1)
# — Turbo4 quantization for KV cache and MTP
#
# Usage: ./start-qwen35-turbo4.sh
#
# Architecture:
...
echo "   Speculative: K=2 (num-drafts 1, turbo4)"
...
echo "   Model: qwen3.5-35b-turbo4"
echo "   KV Cache: turbo4 (~2x lower MSE than nvfp4)"
echo "════════════════════════════════════════════"
