...
// Snapshot original: .research/exllamav3_ref/exl3_gemm_inner.cuh.
// Adaptations (index math and pipeline untouched):
//   * include paths made local; exl3_compat.cuh (MIN/MAX/CEIL_DIVIDE) and
...
)
{
    ...
    #if EXL3_GEMM_H_ACC
        FragC_h frag_c_h[FRAGS_N_PER_WARP];
    #endif
