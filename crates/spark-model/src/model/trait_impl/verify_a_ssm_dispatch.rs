...
//! The SSM checkpoint/rollback/snapshot dispatch arms, split out of
//! `verify_a.rs` to keep it under the 500-line cap.

use super::*;

impl TransformerModel {
    pub(in crate::model::trait_impl) fn checkpoint_ssm_states_dispatch(
        &self,
    ...
    pub(in crate::model::trait_impl) fn rollback_ssm_states_dispatch(
        &self,
        seq: &mut SequenceState,
        num_accepted: usize,
    ) -> Result<()> {
