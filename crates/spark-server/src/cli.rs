...
pub struct ServeArgs {
    ...
    /// MTP head weight precision: bf16 (default, highest accuracy), fp8
    /// (balanced but slower due to D2H sync in MoE), nvfp4 (fastest but
    /// lowest accuracy — not recommended for production).
