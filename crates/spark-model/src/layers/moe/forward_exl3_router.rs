...
// Imported from the EXL3 stack ahead of its GLM-5.3 loader arms: every entry
// point here is called by per-family wiring that this branch has not written
// yet. Remove this allow as the glm5_next EXL3 arms land.
#![allow(dead_code)]
...
impl MoeLayer {
    ...
    pub(super) fn exl3_row_router(
        ...
        // Default ON (2026-09-05). Measured on the 2-draft mHC verify: the
