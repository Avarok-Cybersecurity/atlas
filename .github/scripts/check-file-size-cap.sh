...
allow_list=(
  ...
  # 2026-09-15 DeepSeek-V4.1 Flash bring-up (#1094-#1099): eight files over the
  # cap at first generate; the split is tracked in #1100. Reduce when feasible.
  "crates/spark-model/src/layers/attn_v41.rs"
  "crates/spark-model/src/weight_loader/deepseek_v41.rs"
  "crates/spark-model/src/layers/deepseek_v41_ref/compress.rs"
  "crates/spark-model/src/layers/moe_v41.rs"
  "crates/spark-model/src/layers/deepseek_v41_layer.rs"
