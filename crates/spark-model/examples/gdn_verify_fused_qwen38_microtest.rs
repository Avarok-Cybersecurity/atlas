...
//! [qwen3.8-27b geometry clone: NV=48 v-heads — the original hardcodes
//! qwen3.6's NV=32 and SEGFAULTS against a qwen3.8-compiled module set,
//! leaving the fused verify family unvalidated at this target's dims]
