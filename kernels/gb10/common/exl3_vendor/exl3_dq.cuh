...
// Snapshot original: .research/exllamav3_ref/exl3_dq.cuh.
// Adaptation: added the ptx.cuh include (FragB, FSHF_IMM/BFE16_IMM, bfe64 —
// upstream got these transitively). Bit-window math untouched.
