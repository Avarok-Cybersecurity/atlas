...
use super::super::*;
    ...
    fn parse_qwen3_coder_unclosed_param_then_next_function_does_not_bleed() {
        ...
        assert!(write_args["content"].as_str().unwrap().contains("body-without-close"));
        assert!(write_args.get("command").is_none(),
    ...
    fn streaming_bare_function_flush() {
        ...
        let out1 = det.process("Hello <function>test</function><parameters><name>x</name><value>1</value></parameters>");
