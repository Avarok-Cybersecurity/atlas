# Harness aggregate — tier `eosbaked` (N=10)

Generated from `bench/fp8_dgx2_drift/harness/runs/run_eosbaked_*.json`.
Runs: [1, 10, 2, 3, 4, 5, 6, 7, 8, 9]

| metric | kind | n | mean ± std | p50 | p90 | 95% CI | non-zero runs |
|---|---|---|---|---|---|---|---|
| files_written | count | 10 | 890.700 ± 144.583 | 893.000 | 1168.000 | [789.800, 978.700] | 10/10 |
...
| tool_calls_total | count | 10 | 11.900 ± 3.673 | 14.000 | 17.000 | [9.700, 14.100] | 10/10 |
| write_calls | count | 10 | 2.400 ± 0.800 | 2.000 | 4.000 | [2.000, 3.000] | 10/10 |
...
| wall_time_s | count | 10 | 172.133 ± 82.382 | 160.691 | 325.066 | [124.290, 224.450] | 10/10 |
