...
// Snapshot original: .research/exllamav3_ref/codebook.cuh.
// Adaptation: added the exl3_compat.cuh include (upstream picked up
// half_uint16/half2_uint32 from util.cuh transitively). Decode math untouched.
