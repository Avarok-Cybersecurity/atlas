...
case "$AVAROK_TARGET_HW" in
  r9700) : "${AVAROK_TARGET_MODEL:=qwen3.8-27b}" ;;
  *) : "${AVAROK_TARGET_MODEL:=qwen3.6-27b}" ;;
esac
export AVAROK_TARGET_MODEL
...
echo "nvcc -> $(command -v nvcc)  (SCALE $arch for $AVAROK_TARGET_HW/$AVAROK_TARGET_MODEL/$AVAROK_TARGET_QUANT)"
