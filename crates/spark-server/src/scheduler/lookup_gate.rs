...
pub(super) fn take_lookup_drafts(
    ...
    // AVAROK_LOOKUP_EP=1 lifts the expert-parallelism refusal for measurement.
    ...
    // capped at 3 drafts here regardless of AVAROK_LOOKUP_WIDTH.
    let ep_blocked = ep && std::env::var("AVAROK_LOOKUP_EP").as_deref() != Ok("1");
