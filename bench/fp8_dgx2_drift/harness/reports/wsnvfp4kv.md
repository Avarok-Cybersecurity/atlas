# Harness aggregate — tier `wsnvfp4kv` (N=10)

Generated from `bench/fp8_dgx2_drift/harness/runs/run_wsnvfp4kv_*.json`.
Runs: [1, 10, 2, 3, 4, 5, 6, 7, 8, 9]

| metric | kind | n | mean ± std | p50 | p90 | 95% CI | non-zero runs |
|---|---|---|---|---|---|---|---|
| files_written | count | 10 | 892.900 ± 314.748 | 929.000 | 1198.000 | [674.400, 1043.800] | 10/10 |
...
| tool_calls_total | count | 10 | 15.000 ± 2.530 | 16.000 | 19.000 | [13.400, 16.500] | 10/10 |
| write_calls | count | 10 | 2.100 ± 0.700 | 2.000 | 4.000 | [1.700, 2.600] | 10/10 |
| drift_empty_path | count | 10 | 0.400 ± 1.200 | 0.000 | 4.000 | [0.000, 1.200] | 1/10 |
...
| wall_time_s | count | 10 | 167.032 ± 79.748 | 165.966 | 360.044 | [122.419, 221.300] | 10/10 |
