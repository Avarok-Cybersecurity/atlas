...
The Avarok team maintains a technical paper in `paper/avarok.tex` — a two-column LaTeX document titled:

> **"Avarok: A Custom CUDA Inference Engine for Hybrid Mamba/Attention MoE Models on NVIDIA Blackwell GB10"**
...
- **Software E2M1 on SM121 is viable.** Branchless FP32 → E2M1 conversion in 7 ALU ops closes the gap left by the missing hardware instruction; Avarok's NVFP4 throughput on GB10 is the silicon ceiling.
...
- The **book** covers operations + architecture + contribution workflow. If you want to run or extend Avarok, start here.
...
- **Paper source**: [`paper/avarok.tex`](https://github.com/Avarok-Cybersecurity/avarok/blob/main/paper/avarok.tex) (build with `pdflatex`).
